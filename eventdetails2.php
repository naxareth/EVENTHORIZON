...
if(isset($_POST["submit"])){
  ...
  $query = "INSERT INTO tb_data2 VALUES('', '$name', '$comment', '$date', '$reply_id')";
...
<html lang="en">
  ...
  <body>
    ...
    <main class="grid">
        ...
        <div class="welcome">
          <h2>Cup of Joe and Sunkissed Lola concert to be held during PHINMA University of Pangasinan 99th FDC</h2>NRSCC, Lingayen, Pangasinan</h2><br>
